...
**Файлы.** `tree.js`, `treeVideo.ts`, UI пикера.
**AC.** 2+ эфира в комнате; переключение стрима не рвёт голос; нагрузочный прогон 1 стример + 19 зрителей (микс натив/браузер): дерево стабильно, задержка ≤ 3 c, egress в бюджете.
