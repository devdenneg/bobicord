...
const FILES = {
  entry: '/entry.mp3',        // зашёл в голосовой (слышат все в канале + сам зашедший)
  exit: '/exit.mp3',          // вышел из голосового (слышат все в канале + сам вышедший)
  mute: '/mute.mp3',          // выключил микрофон (только сам)
  unmute: '/unmute.mp3',      // включил микрофон (только сам)
  fullMute: '/fullMute.mp3',  // оглох — кнопка наушников (только сам); повторное = unmute
  ...
  tag: '/tag.mp3',            // тебя тегнули/реплайнули (@ник, @all, ответ) — уведомление
