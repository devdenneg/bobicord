...
const EMPTY: Snapshot = {
  connected: false, roomReady: false, reconnecting: false, voiceQuality: 'unknown', voicePing: null, inVoice: false, voiceConnecting: false, myVoiceChannel: null, voiceChannels: {}, deafened: false, localMicMuted: true, pttDown: false,
