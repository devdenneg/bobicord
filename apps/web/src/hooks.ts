...
const EMPTY: Snapshot = {
  connected: false, roomReady: false, reconnecting: false, voiceQuality: 'unknown', voicePing: null, inVoice: false, voiceConnecting: false, myVoiceChannel: null, voiceServerId: null, voiceChannels: {}, deafened: false, localMicMuted: true, manualMicMuted: true, micUnavailable: false, micRecovering: false, pttDown: false,
